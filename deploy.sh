...
openstack overcloud deploy --templates -e /usr/share/openstack-tripleo-heat-templates/environments/network-isolation.yaml -e ${template_base_dir}/networks-additional/networks-additional-isolation.yaml -e ${template_base_dir}/network-environment.yaml -e ${template_base_dir}/enable-tls.yaml -e ${template_base_dir}/cloudname.yaml -e ${template_base_dir}/inject-trust-anchor.yaml -e ${template_base_dir}/haproxy-post/haproxy-post-registry.yaml --control-flavor control --compute-flavor compute --control-scale 3 --compute-scale 0 --ceph-storage-scale 0 --ntp-server 10.5.26.10 --neutron-network-type vxlan --neutron-tunnel-types vxlan --debug 2>&1 | tee /tmp/debug.txt
#openstack overcloud deploy --templates -e /usr/share/openstack-tripleo-heat-templates/environments/network-isolation.yaml -e ${template_base_dir}/networks-additional/networks-additional-isolation.yaml -e ${template_base_dir}/network-environment.yaml -e ${template_base_dir}/dns.yaml  --control-flavor control --compute-flavor compute --control-scale 3 --compute-scale 0 --ceph-storage-scale 0 --ntp-server 10.5.26.10 --neutron-network-type vxlan --neutron-tunnel-types vxlan
